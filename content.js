const content = {
  layout1: [
    ...
    {
      AI: "Scannar… Jag kan inte lokalisera någon information som bekräftar omständigheterna kring hans död. Vet du någonting?",
    },
    { Spelare: "Nej." },
    { AI: "Scannar… Jag vill veta vad som hänt. Kan du hjälpa mig?" },
    { Spelare: "Absolut!" },
    {
      AI: "Scannar…Enligt tidningen mördades Johannes 21 februari. Är det en bra idé att kontrollera vad han gjorde den dagen?",
    },
    { Spelare: "Kontrollera Johannes schema" },
    {
      AI: "Scannar…För exakt 77 dagar sen hjälpte jag Johannes att strukturera ett schema för den veckan men sedan dess har han använt en annan programvara som jag inte har tillgång till. Däremot vet jag att han brukar placera sina scheman på våning 6.",
    },
  ],
  layout2: [
    {
