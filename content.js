const content = {
  layout1:
    "USER, idag vet du att jag är borta och du vill nog ta reda på vart jag är någonstans. Fortsätt hitta ledtrådar för att veta vem jag är och vart din lärare är någonstans >:)",
  layout2:
    "USER, HEJ!!! Trodde aldrig att du skulle fortsätta leta efter mig, meningen var att du skulle bli rädd eller uttråkad, men men. . . ",
  layout3:
    "Du kommer aldrig få veta vad som har hänt din lärare. Har han gömt sig för sig misslyckade arbete eller är han död?!",
  layout4:
